...
// BUILD_SWIFT_PM=1 SWIFT_TAG=swift-5.8-RELEASE ANDROID_ARCH=aarch64 swift ./get-packages-and-swift-source.swift 5.8
...
var repoTags = ["swift-system" : "1.1.1", "swift-collections" : "1.0.1", "swift-asn1" : "0.7.0",
                "swift-certificates" : "0.1.0", "Yams" : "5.0.1", "swift-package-manager": "swift-5.8-RELEASE"]
